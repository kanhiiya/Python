...
def create_item(
    ...
    **Authentication Required**: Use the Authorize button with your JWT token.
    """
...
async def get_items(
    ...
    return await ItemService.get_items(db, skip, limit)
...
async def delete_item(
    ...
    if not await ItemService.delete_item(db, item_id):
        raise HTTPException(status_code=404, detail="Item not found")
